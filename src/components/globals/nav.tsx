    ...
    return(
        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div className="flex items-center justify-start">
                ...
                <a href="https://Monolith.com" className="flex ml-2 md:mr-24">
            ...
            <div className="flex items-center">
                <div className="flex items-center ml-5">
                    <div>
                    <button onClick={toggleUserMenu} type="button" className="flex text-l bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                    ...
                    <div className={`z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow ${isMenuOpen ? 'block' : 'hidden'} dark:bg-gray-700 dark:divide-gray-600`} id="dropdown-user">
                    ...
                    <ul className="py-1" role="none">
                        ...
                        <li>
                        <a href="#" className="block px-4 py-2 text-l text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Earnings</a>
                        </li>
                        <li>
