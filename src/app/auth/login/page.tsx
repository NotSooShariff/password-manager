...
export default function Login() {
  ...
  return (
    <>
      <div className="h-screen scroll-hidden overflow-hidden">
          ...
          <div className="container px-5 py-24 mx-auto flex">
            <div className="lg:w-1/3 md:w-1/2 bg-gray-900 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
              ...
              <p className="leading-relaxed mb-5">
                Login with your email account or  <Link  className="underline text-blue-600" href="/auth/register">Sign Up</Link> with a new one to get
                started
              </p>
